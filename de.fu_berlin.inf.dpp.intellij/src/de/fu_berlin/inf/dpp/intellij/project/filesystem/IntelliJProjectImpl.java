...
public class IntelliJProjectImpl extends IntelliJContainerImpl
     ...
     * Create this project.
     * <p/>
     * TODO: if an IProject is created only on the client side, it should be a
     * module of the active project. We can add it as such, using the shared .iml
     * file if any.
     */
    ...
    public boolean equals(Object o) {
        if (!(o instanceof IntelliJProjectImpl)) {
            return false;
        }

        IntelliJProjectImpl other = (IntelliJProjectImpl) o;

        return getType() == other.getType() && getFullPath()
                .equals(other.getFullPath()) && getWorkspace()
